...
# Импортируем модуль для проверки сценариев
...
async def handle_scenario_check_file(message: types.Message, state: FSMContext):
    ...
    try:
        # Вызываем функцию проверки сценария из отдельного модуля
        ...
        for part in message_parts:
            await message.answer(scenario_result, parse_mode="Markdown")
